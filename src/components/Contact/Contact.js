                 ...
                 <div className="contactForm">
                     ...
                     <div className="formBox">
                         <div className="inputBox w50">
                             <input type="text" name='firstName' ref={register} required/>
                             <span>First Name</span>
                         </div>
                         <div className="inputBox w50">
                             <input type="text" name='lastName' ref={register} required/>
                             <span>Last Name</span>
                         </div>
                         <div className="inputBox w50">
                         ...
                         <div className="inputBox w50">
                             <input type="text" name='mobileNumber' ref={register} required/>
